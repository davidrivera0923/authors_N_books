...
class Book:
    ...
    def get_all(cls):
        ...
        books = []
        results = connectToMySQL('books_2022').query_db(query)
        for row in results:
    ...
    def save(cls,data):
        ...
        return connectToMySQL('books_2022').query_db(query,data)
    ...
    def get_by_id(cls,data):
        ...
        results = connectToMySQL('books_2022').query_db(query,data)
        book = cls(results[0])
        for row in results:
